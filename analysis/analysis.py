# analysis.py — Population Evolution by Age Groups in Latin America (2000-2023): Dataset by Country and Age Cohort
...
keywords = ['Latin America', 'population', 'demographics', 'CEPAL']
...
print(f"Dataset: Population Evolution by Age Groups in Latin Americ")
print(f"DOI: 10.5281/zenodo.18881028")
...
fig.suptitle("Population Evolution by Age Groups in Latin America (2000-20", fontsize=11, fontweight="bold")
...
print(f"""
Citation:
de la Serna Tuya, Juan Moisés (2026). Population Evolution by Age Groups in Latin America (2000-2023): Datas. Zenodo. https://doi.org/10.5281/zenodo.18881028
""")
